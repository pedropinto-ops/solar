...
async function main() {
  ...
  const property = await prisma.property.upsert({
    ...
    create: {
      ...
      legalName: 'Pousada Vista Mar Hotelaria LTDA',
      cnpj: '12345678000190',
      cadastur: '12.345678.10-0',
      addressStreet: 'Av. Beira Mar',
      addressNumber: '1500',
      addressNeighborhood: 'Praia do Forte',
      addressCity: 'Mata de São João',
      addressState: 'BA',
      addressZip: '48280000',
      phone: '+5571999990000',
      email: 'contato@pousadavistamar.com.br',
      website: 'https://pousadavistamar.com.br',
      timezone: 'America/Bahia',
      bookingSlug: 'pousada-vista-mar',
      primaryColor: '#0066CC',
      checkInTime: '14:00',
      checkOutTime: '12:00',
  ...
  const luxType = await prisma.roomType.create({
    data: {
      propertyId: property.id,
      name: 'Luxo Vista Mar',
      description: 'Quarto luxuoso com vista panorâmica para o mar, varanda privativa.',
      basePrice: dec(450),
      maxOccupancy: 3,
      maxAdults: 2,
      maxChildren: 1,
