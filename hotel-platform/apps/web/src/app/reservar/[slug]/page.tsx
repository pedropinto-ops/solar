...
// WhatsApp do hotel (formato internacional, sem símbolos): 55 + DDD + número.
const WHATSAPP_NUMBER = '5575981492537';
...
export default function PublicReservePage() {
  ...
  return (
    <div className="min-h-screen bg-sand-50">
      {/* Atalho flutuante para o WhatsApp do hotel */}
      <a
        href={WHATSAPP_LINK}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Falar no WhatsApp"
        className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] text-white shadow-lg px-4 py-3 hover:brightness-95 transition"
      >
